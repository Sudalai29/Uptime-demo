    ...
    <div style={{
      ...
      {loading ? (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: 8 }}>
          ...
          <StatBox
            label="PAUSED"
            value={stats.monitors.paused}
            color={YELLOW}
          />
          <StatBox
            label="CHECKS/HR"
            value={stats.checks.last_hour}
            color={CYAN}
          />
          <StatBox
            label="AVG RESP"
      ...
      {/* Footer: links to Prometheus & Grafana */}
      {!error && (
        <div style={{
          ...
          {[
            { label: 'PROMETHEUS', href: 'http://localhost:9090', desc: ':9090' },
            { label: 'GRAFANA',    href: 'http://localhost:3001', desc: ':3001 · admin / cyberpunk' },
            ...
            >
              <span style={{
                ...
                color: 'rgba(0,255,231,0.5)', letterSpacing: 1,
              }}>
                {l.label}
              </span>
