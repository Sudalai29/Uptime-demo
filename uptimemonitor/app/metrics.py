...
from prometheus_client.core import GCCollector, PlatformCollector, ProcessCollector

# ── Disable all default collectors ────────────────────────
# Removes: process_*, python_gc_*, platform_* from /metrics output
# Keeps:   only our custom uptime_* metrics
try:
    REGISTRY.unregister(GCCollector())
except Exception:
    pass
try:
    REGISTRY.unregister(PlatformCollector())
except Exception:
    pass
try:
    REGISTRY.unregister(ProcessCollector())
except Exception:
    pass
